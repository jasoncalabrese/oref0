...
function detectSensitivityandCarbAbsorption(inputs) {
    ...
    if (minDevUsedForAbsorption > 0) {
        console.error('Used min deviation for carb absorption', minDevUsedForAbsorption, 'of', mealBGs, 'times');
    }
